...
class ScholarshipsControllerTest < ActionController::TestCase
  ...
  test "should create scholarship" do
    assert_difference('Scholarship.count') do
      post :create, scholarship: { active: @scholarship.active, caption: @scholarship.caption, global: @scholarship.global, title: @scholarship.title }
    end
  ...
  test "should update scholarship" do
    patch :update, id: @scholarship, scholarship: { active: @scholarship.active, caption: @scholarship.caption, global: @scholarship.global, title: @scholarship.title }
    assert_redirected_to scholarship_path(assigns(:scholarship))
  end
